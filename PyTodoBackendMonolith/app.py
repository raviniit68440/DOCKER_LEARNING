...
connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:my-sql-server-rg123.database.windows.net,1433;Database=free-sql-db-9930100;Uid=azureuser;Pwd={new@2026};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;Encrypt=yes;Encrypt=yes;"
